...
<form action="<%=request.getContextPath() %>/file/goUpload.json" enctype="multipart/form-data" method="post">
 ...
 <fieldset>
 <legend>头像上传</legend>
 <form action="${nginxRoot}/meeting/user/avatar" name="upload" method="POST" enctype="multipart/form-data">
 <!--  http://192.168.101.131:880/meeting/user/avatar -->
 ...
 <fieldset>
 <legend>注册用户头像上传</legend>
 <form action="${nginxRoot}mobile/user/avatar" name="upload" method="POST" enctype="multipart/form-data">
 <!--  http://192.168.101.131:880/meeting/user/avatar -->
   <!-- <form action="http://file.online.gintong.com/mobile/people/avatar" name="upload" method="POST" enctype="multipart/form-data">
 <form action="http://file.online.gintong.com/mobile/user/avatar" name="upload" method="POST" enctype="multipart/form-data">--> 
	<input type="file" name="file"><br>
  ...
  <fieldset>
 <legend>文件上传</legend>
<!--  action="http://192.168.101.131:880/meeting/upload" -->
 <form action="${nginxRoot}/meeting/upload" name="upload" method="POST" enctype="multipart/form-data">
   <!-- <form action="http://file.online.gintong.com/mobile/people/avatar" name="upload" method="POST" enctype="multipart/form-data">
 <form action="http://file.online.gintong.com/mobile/user/avatar" name="upload" method="POST" enctype="multipart/form-data">--> 
	<input type="file" name="file"><br>
		<input type="submit" name="submit" value="nginx upload"> 
...
<img alt="" src="<%=basePath%>/file/get/image/?url=/webserver/upload//meeting/pic/0059187973"/>

<a href="<%=basePath%>/meeting/download?id=${fileId}">下载</a>
<br>
<table>
<tr>
	<td>fileRealName</td>
