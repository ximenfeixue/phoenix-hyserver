...
public class NoticeFieldServiceTest extends BaseManagerTestCase{

	private NoticeFieldService manager;
	
	@Autowired
	public void setNoticeFieldService(NoticeFieldService manager) {
	...
	public void crud() {
		...
		NoticeField obj = newNoticeField();
	...
	public static NoticeField newNoticeField() {
		NoticeField obj = new NoticeField();
		
	  	obj.setNoticeId(new java.lang.Long("1"));
	  	obj.setField(new java.lang.String("1"));
		return obj;
	}
}
