...
public class MeetingSignLabelDataServiceTest extends BaseManagerTestCase{

	private MeetingSignLabelDataService manager;
	
	@Autowired
	public void setMeetingSignLabelDataService(MeetingSignLabelDataService manager) {
	...
	public void crud() {
		...
		MeetingSignLabelData obj = newMeetingSignLabelData();
	...
	public static MeetingSignLabelData newMeetingSignLabelData() {
		MeetingSignLabelData obj = new MeetingSignLabelData();
		
	  	obj.setMslabelId(new java.lang.Long("1"));
	  	obj.setLabelContent(new java.lang.String("1"));
