...
public class MeetingNoticeServiceTest extends BaseManagerTestCase{

	private MeetingNoticeService manager;
	
	@Autowired
	public void setMeetingNoticeService(MeetingNoticeService manager) {
	...
	public void crud() {
		...
		MeetingNotice obj = newMeetingNotice();
	...
	public static MeetingNotice newMeetingNotice() {
		MeetingNotice obj = new MeetingNotice();
		
	  	obj.setReceiverType(new Integer("1"));
	  	obj.setReceiver(new java.lang.Long("1"));
	  	obj.setNoticeType(new Integer("1"));
	  	obj.setNoticeContent(new java.lang.String("1"));
